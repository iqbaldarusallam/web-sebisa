...
export const adminCollections: Record<CmsCollectionKey, AdminCollectionConfig> = {
  ...
  introVideos: {
    ...
    description:
      "Kelola video perkenalan yang tampil di homepage dan halaman Tim.",
    table: "intro_videos",
    path: "/admin/video-perkenalan",
    badge: "CMS Video",
    maxItems: 10,
    fields: [
      { name: "title", label: "Judul video", type: "text", required: true },
      ...
      { name: "showOnHome", label: "Tampil di Homepage", type: "checkbox" },
      { name: "showOnTeam", label: "Tampil di Halaman Tim", type: "checkbox" },
      { name: "sortOrder", label: "Urutan tampil", type: "number", placeholder: "1" },
      { name: "isPublished", label: "Aktif", type: "checkbox" },
    ],
    columns: [
      { key: "thumbnailUrl", label: "Thumbnail", type: "image" },
      { key: "title", label: "Judul" },
      { key: "showOnHome", label: "Homepage", type: "boolean" },
      { key: "showOnTeam", label: "Halaman Tim", type: "boolean" },
      { key: "sortOrder", label: "Urutan" },
      { key: "isPublished", label: "Aktif", type: "boolean" },
    ],
  },
